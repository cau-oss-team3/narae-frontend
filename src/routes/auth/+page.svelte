<script>
    import {Button, Card, CardBody, Col, Container, Form, FormGroup, Input, Row} from "@sveltestrap/sveltestrap";
            ...
            <Col class="col-12 col-md-8 col-lg-6 col-xl-5">
                <Card class="shadow-2-strong" style="border-radius: 1rem;">
                    <CardBody class="p-5 text-center">
                        ...
                        <Form {validated} action="javascript:void(0);" on:submit={(e) => doLogin()} method="post" id="authForm">
                            <FormGroup floating label="E-mail" class="form-outline mb-4">
                                <Input type="email" name="email" id="typeEmail" required bind:value={values.email}/>
                            </FormGroup>

                            <FormGroup floating label="Password" class="form-outline mb-4 form-floating">
                                <Input type="password" name="password" id="typePassword" class="form-control form-control-lg" placeholder="Password" required bind:value={values.password} />
                            </FormGroup>
