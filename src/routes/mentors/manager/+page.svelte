<script>
    ...
    import {Button, Card, CardBody, Container, Form, FormGroup, Input, Row} from "@sveltestrap/sveltestrap";
    ...
    <Row class="d-flex">
        <Card class="shadow-2-strong" style="border-radius: 1rem;">
            <CardBody class="p-5 text-center">
                ...
                <Form {validated} action="javascript:void(0);" on:submit={(e) => id != null ? doUpdate() : doCreate() } method="post" id="authForm">

                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <FormGroup floating label="멘토 이름" class="form-outline mb-4">
                                <Input type="text" name="mentor_name" id="mentor_name" required bind:value={values.mentor_name}/>
                            </FormGroup>

                            <h5 class="" style="margin-top: 20px; margin-bottom: 20px;" ><b>분야 선택</b></h5>

                            <br>
                            <Input type="checkbox" label="백엔드" id="mentor_field0" bind:checked={values.mentor_field0}/>
                            <br>
                            <Input type="checkbox" label="프론트" id="mentor_field1" bind:checked={values.mentor_field1}/>
                            <br>
                        ...
                        <li class="list-group-item">
                            ...
                            <FormGroup floating label="나의 상황을 입력하세요." class="form-outline mb-4">
                                <Input type="textarea" name="situation" id="situation" required bind:value={values.situation}/>
                            </FormGroup>
                            ...
                            <FormGroup floating label="무엇을 하고 싶은지 의도를 입력하세요." class="form-outline mb-4">
                                <Input type="textarea" name="intent" id="intent" required bind:value={values.intent}/>
                            </FormGroup>

                            <FormGroup floating label="이것을 할 때 걱정되는 부분을 입력하세요." class="form-outline mb-4">
                                <Input type="textarea" name="concern" id="concern" required bind:value={values.concern}/>
                            </FormGroup>

                            <FormGroup floating label="이제 도움을 줄텐데 추가로 궁금한 것을 입력하세요." class="form-outline mb-4">
                                <Input type="textarea" name="calibrate" id="calibrate" required bind:value={values.calibrate}/>
                            </FormGroup>
                        </li>
                    </ul>
